    ...
    return (
      <main className="min-h-screen min-h-dvh px-3 py-3 sm:px-5 sm:py-5">
        <div className="mx-auto flex min-h-[calc(100vh-1.5rem)] min-h-[calc(100dvh-1.5rem)] w-full max-w-[1600px] flex-col gap-3 sm:min-h-[calc(100vh-2.5rem)] sm:min-h-[calc(100dvh-2.5rem)] sm:gap-4 lg:flex-row">
          <div className="h-[70vh] w-full rounded-[1.75rem] border border-white/9 bg-panel-sm backdrop-blur-[28px] lg:max-w-sm" />
          <div className="h-[70vh] flex-1 rounded-[1.75rem] border border-white/9 bg-panel-sm backdrop-blur-[28px]" />
        </div>
      </main>
    );
  }
  ...
  return (
    <main className="min-h-screen min-h-dvh px-3 py-3 sm:px-5 sm:py-5">
      ...
      <div className="mx-auto flex min-h-[calc(100vh-1.5rem)] min-h-[calc(100dvh-1.5rem)] w-full max-w-[1600px] flex-col gap-3 sm:min-h-[calc(100vh-2.5rem)] sm:min-h-[calc(100dvh-2.5rem)] sm:gap-4 lg:flex-row">
        ...
        <section className="flex min-h-[70vh] flex-1 flex-col overflow-hidden rounded-[1.75rem] border border-white/9 bg-panel backdrop-blur-[28px] shadow-[0_16px_60px_rgba(7,12,32,0.36)]">
          <header className="border-b border-white/8 bg-app-header px-4 py-5 sm:px-6 lg:px-8 shadow-[0_1px_0_rgba(255,255,255,0.06),0_8px_32px_rgba(0,0,0,0.2)]">
